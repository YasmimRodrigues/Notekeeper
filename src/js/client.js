 ...
 * It provides functions for perfoming these operations and updating the UI accordingly.
 * 
 * @namespace
...
export const client = {
    ...
    notebook: {
        ...
        delete(notebookId) {
            ...
            const /** {HTMLElememt | null} */ $activeNavItem = $deleteNotebook.nextElementSibling ?? $deleteNotebook.previousElementSibling;
    ...
    note: {
         ...
         * @param {Object} noteData - New data fro the note
         */

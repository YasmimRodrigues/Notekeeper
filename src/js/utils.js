 ...
 * @param {string} eventType - The type of event to listener for(e.g., 'click', 'mouseover').
...
/**
 * Actives a navigation item by adding the 'active' class and deactivates the previously active item.
 */
 ...
 * @returns {string} A string representingthe relative time (e.g., "Just now," "5 min ago," "3 hours ago," "2 days ago")
 */
 ...
 * 
 * @param {Object} db - The databse containing notebooks and notes 
